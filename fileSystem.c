...
Data I need:
block_size = 64;
Disk Device: Store the name of the volume name - less than 64 bytes long
Directory needs: name, how to reach that file, linked list of blocks for each file, need to store first
*/
